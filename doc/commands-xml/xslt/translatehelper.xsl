...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:key name="en-commands"   match="translations/elements/element"     use="@key" xpath-default-namespace="" />
  <xsl:key name="en-attributes" match="translations/attributes/attribute" use="@key" xpath-default-namespace="" />
  <xsl:key name="en-values"     match="translations/values/value"         use="@key" xpath-default-namespace="" />
