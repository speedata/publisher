...
h1. Quality assurance and PDF comparison
...
h2. Prerequisites for the comparison
...
pre. sp --jobname reference

creates the correct PDF file. With

pre. sp --jobname reference clean

the redundant and not needed temporaray files are removed. The directory now looks like this:
