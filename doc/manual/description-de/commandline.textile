...
- @--data=NAME@:= Gibt den Namen der XML-Daten an. Voreinstellung ist @daten.xml@. Ebenfalls "konfigurierbar":configuration.html. Wird als Dateiname ein Strich (@-@) angegeben, liest der Publisher die XML-Daten aus der Standard-Eingabe (STDIN).
