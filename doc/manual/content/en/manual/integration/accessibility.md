...
![ay11structure.png](/img/ay11structure.png)

![ay11acrobat.png](/img/ay11acrobat.png)

You can use [pdfuaanalyze](https://github.com/speedata/pdfuaanalyze) to display the structure as an XML tree.
...
This writes the file `publisher-struct.xml` which contains the structure tree of the PDF document. This is useful for debugging and for automated testing of the document structure.
...
* [pdfuaanalyze](https://github.com/speedata/pdfuaanalyze) shows the structure of the document as XML.

## Known limitations

The current issues can be viewed [on GitHub](https://github.com/speedata/publisher/issues?q=is%3Aissue+is%3Aopen+label%3APDF%2FUA).
