...
Since the data file can be structured as you like, special commands are needed to access the data. These are described below and in the appendix under [XPath and Layout Functions]({{< relref "xpath" >}}). In the following we will start from this simple data file:
...
Tables are covered in detail in [chapter on tables]({{< relref "tables" >}}).
