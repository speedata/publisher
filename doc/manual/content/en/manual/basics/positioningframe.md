...
![The areas of the page are addressed with area="...". Some layout functions allow you to specify an area.](/img/positioningareas.png)
...
![The behavior of NextRow](/img/cursor.png)
...
![The text automatically flows into the next free area. If necessary, a page break is inserted.](/img/textoverflow.png)
