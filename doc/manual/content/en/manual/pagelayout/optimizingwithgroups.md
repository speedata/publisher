---
title: "Layout optimization using groups"
weight: 59
type: docs
---
...
Virtual areas are bracketed in `<Group><Contents>...</Contents></Group>` (see the section [Groups (virtual objects)]({{< relref "groups" >}})).
