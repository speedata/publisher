...
![In the simplest case, the page tree in a PDF file consists of a list of the existing pages.](/img/pagetree.png)
...
After a page is reserved for the table of contents, the chapters are output and finally the table of contents is generated. The speedata Publisher inserts the table of contents in the correct position.
...
![The table of contents is created in one pass and inserted at the front.](/img/singlepasstoc.png)
