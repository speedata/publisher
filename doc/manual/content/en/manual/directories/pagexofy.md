---
title: "Page numbers: Page x of y"
weight: 56
type: docs
---
...
Just use the [internal variable]({{< relref "internalvariables" >}}) `$_lastpage` to get the page number of the last page of the previous run.
