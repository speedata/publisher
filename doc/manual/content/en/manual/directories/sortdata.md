...
In addition to the command `<SortSequence>` there is also the possibility to sort and group by `<MakeIndex>`. This command is described in the chapter [Sortierung von Stichwortverzeichnissen]({{< relref "indexcreation" >}}).
