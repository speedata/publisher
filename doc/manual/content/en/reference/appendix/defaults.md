...
The last four are used in tables. See the section [Text formats in tables]({{< relref "/manual/tables#text-formats-in-tables" >}}).
...
## Colors
The known CSS colors are defined in the RGB color space. The colors 'black' and 'white' are defined in the grayscale color space. See also the command [`DefineColor`]({{< relref "/reference/commands/definecolor" >}}), there the predefined colors are listed.
