...
These file names can be used for [Images]({{< relref "/reference/commands/image" >}}), for [XPath- and layoutfunctions]({{< relref "/reference/xpath/xpath" >}}) as well as on the command line.
