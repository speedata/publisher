...
The contents of the element [`AtPageCreation`]({{% relref "atpagecreation" %}}) is executed the first time the page is accessed. This is used in [`Pagetype`]({{% relref "pagetype" %}}).
...
`graphic` (text, optional, _since version 4.3.14_)
