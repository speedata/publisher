...
![Schnittmarken und Beschnittzugabe im Adobe Acrobat](/img/schnittmarken.png)

{{< callout >}}
Der Befehl `<PDFOptions>` bietet die Möglichkeit, Voreinstellungen für den Druckdialog im PDF-Anzeigeprogramm festzulegen.
{{< /callout >}}
