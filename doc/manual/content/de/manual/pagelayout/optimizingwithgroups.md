---
title: "Layout-Optimierung mit Gruppen"
weight: 59
type: docs
---
...
Virtuelle Flächen werden in `<Group><Contents>...</Contents></Group>` eingeklammert (siehe den Abschnitt [gruppen]({{< relref "groups" >}})).
...
* die Gruppe in einer Schleife mit veränderten Parametern erneut erzeugen, bis eine Bedingung erfüllt ist (ein Beispiel für dieses Verfahren ist im Abschnitt über Virtuelle Seiten, Nr. [SavePages]({{< relref "savepages" >}}) gezeigt.)
* ...
