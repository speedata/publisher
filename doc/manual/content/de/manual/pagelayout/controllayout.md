...
Der Name des Modus ist frei wählbar, sollte aber keine Leerzeichen oder Komma enthalten.
...
Die interne Variable `_mode` hat ebenfalls eine kommaseparierte Liste der Modi, genau wie auf der Kommandozeile angegeben.
