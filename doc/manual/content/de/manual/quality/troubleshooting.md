---
title: "Fehlerbehebung / Debugging"
weight: 67
type: docs
---
...
`textformat`
: Erzeugt über jeder Textzeile einen Tooltip, der das benutzte Textformat anzeigt. Siehe das Beispiel im Abschnitt [Textformate]({{% relref "textformat" %}}).
