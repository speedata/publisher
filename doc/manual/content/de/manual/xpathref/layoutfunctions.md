...
Neben diesen gibt es [XPath-Standardfunktionen]({{< relref "xpathfunctions" >}}) und [selbstdefinierte Funktionen]({{< relref "/reference/function" >}}).
...
`sd:pagenumber(<Marke>)`
: Liefert die Seitenzahl der Seite, auf der die Marke ausgegeben wurde. Siehe [Mark]({{% relref "/reference/mark" %}}).
