---
title: "Barrierefreiheit / getaggtes PDF"
weight: 81
type: docs
---
...
Als Voreinstellung ist die Rolle »Document« definiert mit der ID `doc`. Dies entspricht der folgenden Struktur:
...
Dieses Layout ist auch im [Beispiele-Repository](https://github.com/speedata/examples/tree/master/accessibility) zu finden und erstellt ein PDF/UA konformes PDF, das den Ansprüchen für die Barrierefreiheit genügt. Unterhalb der obersten Ebene Document gibt es einen Abschnitt Sect, das eine Überschrift, einen Absatz ohne Besonderheiten und einen Absatz mit einem Hyperlink sowie eine Abbildung enthält.
...
_Die Ausgabe aus dem Layout oben ist wie erwartet._
![ay11output.png](/img/ay11output.png)

Mit verschiedenen Werkzeugen kann man prüfen, wie die Struktur des Dokuments aufgebaut ist:

![Der Accessibility checker gibt genau die vorgegebene Struktur aus. Das b-Tag in der Überschrift wird nicht in der Struktur angezeigt.](/img/ay11structure.png)

![Der Adobe Acrobat gibt neben einer detaillierten Überprüfung auch eine visuelle Ansicht der Struktur.](/img/ay11acrobat.png)

Mit [pdfuaanalyze](https://github.com/speedata/pdfuaanalyze) kann man sich die Struktur als XML-Baum ausgeben lassen.
...
Damit wird die Datei `publisher-struct.xml` geschrieben, die den Strukturbaum des PDF-Dokuments enthält. Das ist nützlich zum Debuggen und für automatisierte Tests der Dokumentstruktur.

## Überprüfen des Dokuments

Um die Barrierefreiheit zu überprüfen, bieten sich folgende Programme an:

* [PAC (PDF accessibility checker)](https://pac.pdf-accessibility.org/de)
* Adobe Acrobat
* [Vera PDF](https://verapdf.org)
* [pdfuaanalyze](https://github.com/speedata/pdfuaanalyze) gibt die Struktur des PDFs als XML-Baum aus

## Bekannte Einschränkungen

Die aktuellen Probleme können [auf GitHub angesehen werden](https://github.com/speedata/publisher/issues?q=is%3Aissue+is%3Aopen+label%3APDF%2FUA).
