---
title: "Seitenzahlen: Seite x von y"
weight: 56
type: docs
---
...
Die [interne Variable]({{< relref "internalvariables" >}}) `$_lastpage` enthält die Anzahl der Seiten im vorherigen Durchlauf.
...
Am Ende der letzten Seite kann die Information mithilfe von `<SaveDataset>` für den nächsten Lauf zwischengespeichert werden:
