...
![Der Seitenbaum in einer PDF-Datei besteht im einfachsten Fall aus einer Liste der vorhandenen Seiten.](/img/pagetree.png)

Es ist möglich, die Reihenfolge der Seiten nachträglich zu ändern, indem die Liste der Seiten geändert wird.
...
![Das Inhaltsverzeichnis wird in einem Durchlauf erzeugt und vorne eingefügt.](/img/singlepasstoc.png)
