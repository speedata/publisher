...
![Diverse Sonderfarben sind im Publisher vorgegeben, so die Farbe Pantone 116.](/img/box116c.png)
...
![Die neue Farbe erscheint im PDF als eigener Farbkanal](/img/speedatagruen.png)
...
Transparenz funktioniert möglicherweise nicht mit jedem Grafikobjekt. Bitte nicht zögern und ggf. einen [Fehlerbericht]({{< relref "troubleshooting" >}}) schreiben.
