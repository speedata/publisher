---
title: "Wie man das Layout schreibt"
weight: 50
type: docs
---
...
Mithilfe der mitgelieferten XML Schemata ([RELAX NG](https://de.wikipedia.org/wiki/RELAX_NG) und [XML Schema (XSD)](https://de.wikipedia.org/wiki/XML_Schema)) wird die Eingabe des Layoutregelwerks deutlich erleichtert.
...
für XSD, je nach gewünschter Sprache der Dokumentation. Weitere Informationen zum Schema gibt es im Kapitel [schemavalidierung]({{< relref "schema" >}}) und im Anhang [Installationsanleitungen für verschiedene Editoren (z.B. oXygen, Visual Studio Code)]({{< relref "schema" >}}).
