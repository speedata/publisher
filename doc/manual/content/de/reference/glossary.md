...
Wohlgeformt
: Eine XML-Datei ist wohlgeformt, wenn mindestens die folgenden Bedingungen erfüllt sind (aus der [Wikipedia](https://de.wikipedia.org/wiki/Extensible_Markup_Language#Wohlgeformtheit)):
