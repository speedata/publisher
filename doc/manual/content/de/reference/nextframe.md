...
Schaltet auf den nächsten freien Rahmen eines Platzierungsbereichs um.
...
`area` (Text)
: Name des Platzierungsbereich, in dem der nächste Rahmen gesucht werden soll.
