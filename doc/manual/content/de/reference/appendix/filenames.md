...
* Datei innerhalb des Suchbaums `datei.png`. Vor dem Start wird das aktuelle Verzeichnis rekursiv durchsucht (siehe [Dateiorganisation]({{< relref "fileorganization" >}})).
...
Diese Dateinamen können bei [Bildern]({{< relref "/reference/commands/image" >}}), bei [XPath- und Layoutfunktionen]({{< relref "/reference/xpath/xpath" >}}) sowie auf der Kommandozeile benutzt werden.
