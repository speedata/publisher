...
`dashed` (optional, CSS Eigenschaft: border-style, _seit Version 2.3.61_)
...
Funktioniert derzeit nicht zusammen mit optischem Randausgleich.
...
<PlaceObject>
  <Textblock>
    <Paragraph>
      <U><Value>Unterstrichener Text</Value></U>
    </Paragraph>
  </Textblock>
</PlaceObject>
```
