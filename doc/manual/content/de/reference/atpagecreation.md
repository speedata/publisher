...
Die Inhalte des Elements [`AtPageCreation`]({{% relref "atpagecreation" %}}) werden ausgeführt, sobald das erste Mal auf die Seite zugegriffen wird. Dieser Befehl kann in einem Seitentyp ([`Pagetype`]({{% relref "pagetype" %}})) benutzt werden.
...
<a href="../pagetype"><code>Pagetype</code></a>

## Attribute


`graphic` (Text, optional, _seit Version 4.3.14_)
