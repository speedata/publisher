...
Eine ausführliche Beschreibung der HTML-Funktionen einschließlich CSS-Styling ist im Abschnitt <<ch-html>> zu finden.
...
. Scherungen (skew) sind durch 1 tan α tan β 1 0 0 beschrieben.
...
.Scherung und Skalierung durch die Transformationsmatrix.
image::eagle-transform.png[width=50%,scaledwidth=100%]
//~

[[ch-objekteausgeben-flip]]
...
[[fig-clippedobject]]
.Ein beschnittenes und ein unbeschnittenes Bild.
