...
[[fig-questionmark-table]]
.Angaben von ?-Spalten lässt die Breiten wieder dynamisch berechnen
image::tab-questionmark.png[width=40%,scaledwidth=100%]
...
Um Tabellen mit keiner Schriftgröße zu setzen, muss die Schriftfamilie in der Tabellendefinition auf eine kleine Schriftfamilie gesetzt werden:
