...
TIP: Absolut platzierte Objekte belegen in der Voreinstellung keine Flächen im Raster. In dem Fall ist `allocate="no"` gesetzt. Mit `allocate="yes"` kann das Verhalten den im Raster platzierten Objekten gleich gesetzt werden.
