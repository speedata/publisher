...
-   https://www.gnu.org/software/emacs/[GNU Emacs] mit https://www.gnu.org/software/emacs/manual/html_mono/nxml-mode.html[nxml-mode] (alle Betriebssysteme, kostenlos)
