...
Durch die einzigartige Kombination von ausgefeilten Algorithmen und Programmierbarkeit lassen sich äußerst flexible Layouts realisieren, die bisher nur interaktiven Desktop-Publishing-Programmen (DTP) wie InDesign von Adobe vorbehalten waren.
