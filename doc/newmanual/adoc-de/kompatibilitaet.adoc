...
* Das Windows-Installationsprogramm begrenzt die Länge der PATH-Variable auf 1024 Zeichen (Siehe Fehler https://github.com/speedata/publisher/issues/582[#582].)
