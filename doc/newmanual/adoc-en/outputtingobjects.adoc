...
A detailed description of the HTML features including CSS styling is given in the section <<ch-html>>.
...
. The identity transformation is 1 0 0 1 0 0.
...
[[ch-outputtingobjectds-flipping]]
== Flipping objects
