...
There is nothing special about thumb indexes at first, they are either created with boxes or lines in a certain colour. An example of chapter numbers in a square box follows.
