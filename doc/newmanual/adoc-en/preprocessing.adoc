...
There are several ways to validate RELAX NG files. Beside a variant to validate the schema directly in the XML editor (see the corresponding <<ch-schema validation, section in the manual>>) there is the possibility to use an external program for this.
