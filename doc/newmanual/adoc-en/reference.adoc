...
The command <<cmd-savepages,`<SavePages>`>>, the section <<ch-savepages>> and <<ch-cookbook-toinonerun>>.
...
The command <<cmd-insertpages,`<InsertPages>`>>, the section <<ch-savepages>> and <<ch-cookbook-toinonerun>>.
