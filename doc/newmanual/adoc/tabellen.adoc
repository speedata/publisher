  ...
  <Record element="data">
    <PlaceObject>
      <Table padding="2mm" stretch="no" >
        <Tr>
          <Td>
            <Paragraph><Value>Zeile 1 / Zelle 1</Value></Paragraph>
          </Td>
          <Td>
            <Paragraph><Value>Zeile 1 / Zelle 2</Value></Paragraph>
          </Td>
        </Tr>
        <Tr>
          <Td>
            <Paragraph><Value>Zeile 2 / Zelle 1</Value></Paragraph>
          </Td>
          <Td>
            <Paragraph><Value>Zeile 2 / Zelle 2</Value></Paragraph>
          </Td>
        </Tr>
      </Table>
    </PlaceObject>
...
<!-- wenn page="first" wie unten definiert wird,
     gilt die obige Definition für alle aber nicht für die erste Seite -->
...
-------------------------------------------------------------------------------
<data>
  <abschnitt name="Abschnitt 1" zeilen="2"/>
  <abschnitt name="Abschnitt 2" zeilen="8"/>
</data>
-------------------------------------------------------------------------------
    ...
    <PlaceObject>
      <Table padding="1mm" stretch="max">
        <ForAll select="abschnitt">
          ...
          <Loop select="@zeilen" variable="i">
            <Tr>
              <Td>
                <Paragraph>
                  <Value select="concat('Zeile ', $i)"/>
                </Paragraph>
              </Td>
            </Tr>
          </Loop>
