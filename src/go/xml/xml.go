...
// InputPos retuns the line of the current decoder position and the 1 based input position of the line.
// The position gives the location of the end of the most recently returned token.
