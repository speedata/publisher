...
P("\217") * R("\160\169") +
P("\219") * R("\176\185") +
P("\224") * ( P("\165") * R("\166\175") + P("\167") * R("\166\175") + P("\169") * R("\166\175") + P("\171") * R("\166\175") + P("\173") * R("\166\175") + P("\175") * R("\167\175") + P("\177") * R("\166\175") + P("\179") * R("\166\175") + P("\181") * R("\166\175") + P("\185") * R("\144\153") + P("\187") * R("\144\153") + P("\188") * R("\160\169") )
...
P("\206") * P("\135") +
P("\217") * P("\128") +
P("\224") *  ( P("\185") * P("\134") + P("\187") * P("\134") )  +
P("\227") * ( P("\128") * P("\133") +  P("\128") * R("\177\181")  +  P("\130") * R("\157\158") +  P("\131") * R("\188\190")) 
...
function textvalue( tab )
  ...
  if type(tab)=="table" then
    if #tab ~= 1 then
      fehler("Sequenz darf nur ein Item haben")
    end
    tab = tab[1]
  end
  local ret = {}
...
function mktree( a,b,c )
  -- w("a=%s, b=%s, c=%s",a or "?",b or "?",c or "?")
  return { b, a, c}
end
...
function _funcall( ... )
  ...
  if fun==nil then
    fehler("Unbekannte Funktion %q", name or "???")
    return nil
  end
